# Hi there 👋, I'm Devakinandan Palla (Dev)
...
- **Language Translator**  
  Implemented a neural network-based translation tool for multi-lingual applications (English to Telugu Language Translator)
